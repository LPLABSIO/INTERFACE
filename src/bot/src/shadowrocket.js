const { log, findAndClickWithPolling, findAndSetValue, findAndClickWithPollingIfNotEnabled, checkAndTerminateApp, randomWait } = require('./utils');
...
async function configureShadowrocket(client, proxyInfo, city) {
    try {
        ...
        try {
            ...
            await require('./utils').findAndTypeCharByChar(client, proxyInfo.password, true);
