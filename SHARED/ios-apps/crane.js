const { log, findAndClickWithPolling, checkAndTerminateApp, findAndSetValue, randomWait } = require('../utils/utils');
...
async function performCraneForApp(client, appName, city) {
    try {
        ...
        // Attendre 2 secondes avant de fermer pour sauvegarder les changements
